...
/**
 * Tencent Maps (腾讯地图) tile source for the VTM (mapsforge-vtm) renderer.
 * Uses GCJ-02 coordinates (hence {@link Gcj02CoordinateConverter}) and inverted Y axis ({@code {-Y}}).
...
class TencentVTMSource extends AbstractMapsforgeVTMOnlineTileProvider {
    ...
    TencentVTMSource() {
        super(LocalizationUtils.getPlainString(R.string.map_source_tencent),
                ...
                new String[]{"https://rt0.map.gtimg.com", "https://rt1.map.gtimg.com", "https://rt2.map.gtimg.com", "https://rt3.map.gtimg.com"});
    }
